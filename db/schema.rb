...
ActiveRecord::Schema[8.0].define(version: 2025_08_15_012947) do
  ...
  create_table "associates", force: :cascade do |t|
    ...
    t.decimal "initial_contribution", precision: 10, scale: 2, default: "0.0"
    t.decimal "current_account_balance", precision: 10, scale: 2, default: "0.0", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "encrypted_password", default: "", null: false
    t.string "reset_password_token"
