class FinancialOperationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @financial_operation.save
        format.html { redirect_to @financial_operation, notice: "Financial operation was successfully created." }
  ...
  def update
    respond_to do |format|
      if @financial_operation.update(financial_operation_params)
        format.html { redirect_to @financial_operation, notice: "Financial operation was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to financial_operations_path, status: :see_other, notice: "Financial operation was successfully destroyed." }
  ...
  private
    ...
    def set_financial_operation
      @financial_operation = FinancialOperation.find(params.expect(:id))
    end
